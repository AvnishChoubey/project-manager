...
public class CommentController {
    ...
    public ResponseEntity<CommentResponse> updateComment(@PathVariable("projectId") Long projectId, @PathVariable("taskId") Long taskId, @PathVariable("commentId") Long commentId, @RequestBody String commentContent) {
